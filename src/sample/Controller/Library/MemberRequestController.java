...
public class MemberRequestController {
    ...
    public void MemberShip(javafx.event.ActionEvent event){
        ...
        MemberRequest memberRequest = new MemberRequest(memberName,memberLastname,memberNationalCode,memberAge,memberGender,memberPhoneNumber,memberAddress,memberUserName,memberPassword,memberShip);
